...
############################
# Build entservices-powermanager
echo "buliding entservices-powermanager"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-powermanager \
-DUSE_THUNDER_R4=ON \
...
-DCMAKE_DISABLE_FIND_PACKAGE_Telemetry=ON \
-DCOMCAST_CONFIG=OFF \
